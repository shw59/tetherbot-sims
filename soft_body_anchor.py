...
boxId = p.loadURDF("objects/robot_blue.urdf", [0,1,2], useMaximalCoordinates = True)

clothId = p.loadSoftBody("objects/tether.obj", 
                         basePosition = [0,0,2], 
                         scale = 2, 
                         mass = 1., 
                         useNeoHookean = 0, 
...
p.changeVisualShape(clothId, -1, rgbaColor=[1.0, 0.2, 0.58, 1.0], flags=p.VISUAL_SHAPE_DOUBLE_SIDED)
