...
class World:
    ...
    def create_agent(self, position_0, heading_0, radius, goal_delta=None, mass=17, color=(0, 0.5, 1, 1), height=0.01, mu_static=0.9, mu_dynamic=0.5, max_velocity=50, max_velocity_angular=10, drive_power=500):
        """
