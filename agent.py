...
class Agent:
    ...
    def __init__(self, position_0, heading_0, radius, mass, color, height, friction_coeff, max_velocity):
        """
        ...
        p.changeDynamics(self.id, 0, linearDamping=friction_coeff, maxJointVelocity=max_velocity)
        p.changeDynamics(self.id, 1, linearDamping=friction_coeff, maxJointVelocity=max_velocity)
        p.changeDynamics(self.id, 2, linearDamping=friction_coeff, maxJointVelocity=max_velocity)
